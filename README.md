...
*   🔭 **Currently focusing on:** Deepening my understanding of Machine Learning architectures and building end-to-end applications.
*   🌱 **Continuously learning:** Advanced data manipulation with **Pandas** and **NumPy**, and data visualization using **Matplotlib**.
*   👨‍💻 **Workflow:** My daily development environment is heavily centered around **VS Code**, customized and optimized for Python and C++ development.
*   💬 **Ask me about:** Python, C++, getting started in ML, and merging technical algorithms with creative digital manipulation.
